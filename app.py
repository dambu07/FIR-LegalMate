...
from audio import transcribe_audio, text_to_speech, get_audio_input
...
if input_type == "Text":
    ...
    st.write("Upload an audio file (supported languages: English, Hindi)")
    audio_file = get_audio_input()
    if audio_file:
        language = st.selectbox("Select language:", ("English", "Hindi"))
        lang_code = "en-IN" if language == "English" else "hi-IN"
        user_input = transcribe_audio(audio_file, lang_code)
...
if st.button("Process"): 
    if user_input: 
        ...
        output_language = "en" if input_type == "Text" or language == "English" else "hi"
